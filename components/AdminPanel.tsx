...
export default function AdminPanel() {
  ...
  async function handleReset() {
    ...
    const { error } = await supabase
      .from('profiles')
      .update({ portfolio_balance: 15000 })
    ...
    <div className="min-h-screen bg-black text-white p-8 font-mono">
      ...
      <div className="border border-green-900 bg-[#0f1a0f] rounded-xl p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <input placeholder="Amount (USD)" type="number" value={amount} onChange={e => setAmount(e.target.value)}
        ...
        <button onClick={handleUpdate} className="bg-green-800 hover:bg-green-700 text-green-200 px-5 py-2 rounded-md text-sm transition-colors">
          Apply Balance
        </button>
      </div>
      ...
      <div className="border border-green-900 bg-[#0f1a0f] rounded-xl p-6 mb-6">
        ...
        <table className="w-full text-sm">
          <thead><tr className="text-green-400 text-xs tracking-wider">
      ...
      <div className="border border-red-900 bg-[#120a0a] rounded-xl p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleReset} className="border border-red-900 text-red-400 hover:bg-red-950 px-4 py-2 rounded-md text-sm transition-colors">
            Reset All
          </button>
        </div>
      </div>
